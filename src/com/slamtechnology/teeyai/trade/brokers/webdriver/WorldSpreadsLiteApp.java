...
public class WorldSpreadsLiteApp extends WorldSpreadsApp {

	private WorldSpreadsLiteApp() {

		log = LoggerFactory.getLogger(Broker.class.getName());
		createNewDriver();
	}
	...
	private WebElement findMarketRow(String name) {
		...
		WebElement popularMarkets = driver.findElement(By
				.id("divPopularMarket"));
		log.info("Looking for my market row");
		while (true) {
