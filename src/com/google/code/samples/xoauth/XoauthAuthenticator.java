...
public class XoauthAuthenticator {
  ...
  public static Session getSession(boolean debug){
	    Properties props = new Properties();
  ...
  public static SMTPTransport connectToSmtp(Session session) throws Exception {
	  return connectToSmtp("smtp.googlemail.com",
              587,
              "damnpanache@gmail.com",
              session,
  ...
  public static SMTPTransport connectToSmtp(String host,
                                            ...
                                            OAuthConsumer consumer,
                                            boolean debug) throws Exception {
    String oauthToken = "1/k6blsIJx06wM8P4SU940_mzwqFRZfR-yF4CAP_7Dqwo";
    String oauthTokenSecret = "mYBo8FU0GFRLeq/iswLSbKwH";
